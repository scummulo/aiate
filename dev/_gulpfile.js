...
// Paths
var IN = {
  js: 'wp-content/themes/' + themeName + '/custom/assets/js/',
  sass: 'wp-content/themes/' + themeName + '/custom/assets/sass/*'
}

var OUT = {
  js: 'wp-content/themes/' + themeName + '/custom/assets/js/',
  css: 'wp-content/themes/' + themeName + '/custom/assets/css/'
}
...
gulp.task('browserSync', ['sass', 'scripts', 'cache'], function() {
  browserSync.init([OUT.css + '*', OUT.js + '*', './**/*.php'], {
    // proxy: serverAlias,
    port: 8080
  })
});
