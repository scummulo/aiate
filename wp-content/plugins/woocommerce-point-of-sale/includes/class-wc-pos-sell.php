...
#	        add_action( 'wp_login', array( $this, 'set_last_login') );
    ...
    public function addon_hook_wc_address_validation_js($register)
    {
        if (function_exists('wc_address_validation')) {
            global $wp_scripts;
            wc_address_validation()->handler->show_billing_postcode_lookup();
            wc_address_validation()->handler->show_shipping_postcode_lookup();
            wc_address_validation()->handler->load_validation_js();
