...
class WC_POS
{
    ...
    private function init_hooks()
    {
        ...
        add_action('init', array($this, 'check_register_position'));
        //Pos only products
    ...
    public function check_register_position()
    {
        if (get_option('woocommerce_pos_register_revert_columns', 'yes') == 'no') {
            update_option('woocommerce_pos_register_revert_columns', 'yes');
            add_option('woocommerce_pos_register_revert_columns', 'yes');
        }
    }
}