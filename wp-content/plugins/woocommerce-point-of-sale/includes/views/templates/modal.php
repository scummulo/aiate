...
<script type="text/template" id="tmpl-product-addons">
    ...
    <table class="product-fields-table" data-required="{{required}}">
        <tr>
            <td><p class="product_addon_label">{{name}} {{#if required}}<abbr class="required" title="Required field">*</abbr>{{/if}}</p>
        ...
        {{#each options}}
                ...
                <textarea data-raw-price="{{price}}" data-price="{{price}}" placeholder="{{label}}{{{accountingPOS price}}}"
        ...
        {{#each options}}
                ...
                <input type="text" data-raw-price="{{price}}" data-price="{{price}}" placeholder="{{label}}{{{accountingPOS price}}}"
        ...
        {{#each options}}
        		<label class="pos_addon_label pos_addon_text">
                <input type="email" data-raw-price="{{price}}" placeholder="{{label}}{{{accountingPOS price}}}" data-price="{{price}}"
        ...
        {{#each options}}
        		<label class="pos_addon_label pos_addon_text">
                <input type="number" step="any" data-raw-price="{{price}}" placeholder="{{label}}{{{accountingPOS price}}}"
        ...
        {{#each options}}
        		<label class="pos_addon_label pos_addon_text">
                <input type="text" data-raw-price="{{price}}" data-price="{{price}}" pattern="[A-Za-z]*" placeholder="{{label}}{{{accountingPOS price}}}"
        ...
        {{#each options}}
        		<label class="pos_addon_label pos_addon_text">
                <input type="text" data-raw-price="{{price}}" data-price="{{price}}" pattern="[0-9]*" placeholder="{{label}}{{{accountingPOS price}}}"
                       class="input-text addon addon-custom addon-custom-pattern {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}"
                       {{product_addons_maxlength}}>
        		</label>
        {{/each}}
        ...
        {{#each options}}
        		<label class="pos_addon_label pos_addon_text">
                <input type="text" data-raw-price="{{price}}" data-price="{{price}}" pattern="[A-Za-z0-9]*" placeholder="{{label}}{{{accountingPOS price}}}"
                       class="input-text addon addon-custom addon-custom-pattern {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}"
                       {{product_addons_maxlength}}>
        		</label>
        {{/each}}
        ...
        {{#each options}}
        		<label class="pos_addon_label pos_addon_text">
                <input type="number" step="any" data-raw-price="{{price}}" data-price="{{price}}"placeholder="{{label}}{{{accountingPOS price}}}"
