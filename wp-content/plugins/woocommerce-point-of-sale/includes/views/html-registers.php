...
<div class="wrap" id="wc-pos-registers-edit">
    <div id="regiser_top_bar">
        ...
        <div class="wp-heading" id="pos_register_buttons">
            <?php $current_user = wp_get_current_user(); ?>
            <a class="pos_register_user_panel <?php echo get_option('woocommerce_pos_register_branding') ?>" href="<?php echo $admin_url; ?>admin.php?page=wc_pos_registers">
                ...
                <div id="postbox-container-<?php echo ($revert_columns == 'no' || !$revert_columns) ? '2' : '1' ?>"
                    ...
                    <div id="wc-pos-register-buttons" class="postbox ">
                        <div class="tbc">
                            <div class="tb">
                                <div class="tbr">
                                    <div class="wc_pos_register_void page-title-action" type="button"><?php _e('Void', 'wc_point_of_sale'); ?></div><div class="wc_pos_register_save page-title-action" type="submit"><?php _e('Save', 'wc_point_of_sale'); ?></div><div class="wc_pos_register_pay page-title-action" type="button"><?php _e('Pay', 'wc_point_of_sale'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="wc-pos-actions" class="postbox">
                        ...
                        <?php if (get_option('wc_pos_custom_fee', 'no') == 'yes') { ?>
                            <a class="button  wc_pos_register_custom_fee" type="button"
                               href="#"><span class="currency_symbol"><?php echo get_woocommerce_currency_symbol(); ?></span><?php _e('Fee', 'wc_point_of_sale'); ?>
                            </a>
                        <?php } ?>
