                                    ...
                                    <table class="tendered_change_cod">
                                        <tr>
                                            <th class="amount_tendered">
                                                <label><?php _e('Amount Tendered', 'wc_point_of_sale'); ?></label></th>
                                        ...
                                        <tr>
                                            <th class="amount_change">
                                                <label><?php _e('Issue Change', 'wc_point_of_sale'); ?></label></th>
        ...
        <div class="pos_end_toggles">
	        <div id="payment_switch_wrap">
	                <input type="checkbox" class="payment_switch" value="yes" name="payment_print_gift_receipt"
                           ...
                           data-label-text="<span class='payment_gift_receipt_switch_label'></span>" data-on-text="Yes"
                    ...
                    <input type="checkbox" class="payment_switch" value="yes" name="payment_email_receipt"
                           ...
                           data-label-text="<span class='payment_email_receipt_switch_label'></span>" data-on-text="Yes"
                    ...
                    <input type="checkbox" class="payment_switch" value="yes" name="payment_print_receipt"
                           ...
                           data-label-text="<span class='payment_switch_label'></span>" data-on-text="Yes"
